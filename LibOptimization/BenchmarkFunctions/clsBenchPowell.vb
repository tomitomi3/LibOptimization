...
Namespace BenchmarkFunction
    ...
    Public Class clsBenchPowell : Inherits absObjectiveFunction
        ...
        Public Overrides Function Gradient(ByVal ai_var As List(Of Double), Optional h As Double = 0.000001) As List(Of Double)
            Throw New NotImplementedException
        End Function

        Public Overrides Function Hessian(ByVal ai_var As List(Of Double), Optional h As Double = 0.000001) As List(Of List(Of Double))
            Throw New NotImplementedException
        End Function
